...
def create_dashboard_entries(user, workspace=None, mixed_order=False):
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_data=clean_extra_spaces(
            ...
            (2) Reset dashboards triggers/hoocks, (3) Pre-defined template 
            system for workspaces (with
            plugins in), (4) Copy/paste widgets between workspaces.", 
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_data=clean_extra_spaces(
            ...
            "image": "icon-thumbs-up", "external": true, 
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_uid='url_1x1',
        plugin_data=clean_extra_spaces(
            """{"url": "http://foreverchild.info/", "image": "icon-star",
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_data=clean_extra_spaces(
            ...
            "image": "icon-youtube", "external": true, 
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_data=clean_extra_spaces(
            """{"text": "", "lipsum_language": "en", "show_title": false,
...
def create_news_and_rss_dashboard_entries(user, workspace):
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_data=clean_extra_spaces(
            """{"url": "http://delusionalinsanity.com/portfolio/",
            "image": "icon-picture", "external": true, 
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_uid='news_4x5',
        plugin_data=clean_extra_spaces(
            """{"truncate_after": 35, "max_items": 5, "show_title": true,
            "cache_for": 3600}"""
        ),
        position=1
    )
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_data=clean_extra_spaces(
            """{"custom_feed_title": "News feed", "truncate_after": 35,
            "feed_url": "http://foreverchild.info/rss/", 
            "cache_for": 3600, "show_feed_title": true,
            "max_items": 6}"""
        ),
        position=5
    )
    ...
    dashboard_entry = DashboardEntry(
        ...
        plugin_uid='dummy_2x1',
        plugin_data=clean_extra_spaces(
            """{"text": "Quis inceptos. Urna libero tortor nonummy pretium. Lectus.
            Platea eu, ligula lacinia dis, parturient consequat. Nunc tempor pretium natoque cubilia nunc. Ligula
            at, nulla. Congue at. Mauris. Luctus...", "lipsum_max_chars": 200, 
            "lipsum_language": "en",
